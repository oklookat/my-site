...
// AHash - returns an Argon2id hash of a plain-text password using the
...
//
func AHash(password string, params *Params) (hash string, err error) {
...
// AHashCheck - check argon2id hash.
func AHashCheck(password, hash string) (match bool, err error) {
