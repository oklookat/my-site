...
(
    ...
    password   character varying(248) COLLATE pg_catalog."default"                            NOT NULL,
    reg_ip     character varying(54) COLLATE pg_catalog."default"  DEFAULT 'unknown':: character varying,
    reg_agent  character varying(324) COLLATE pg_catalog."default" DEFAULT 'unknown':: character varying,
...
(
    ...
    token      character varying(2048) COLLATE pg_catalog."default"                          NOT NULL,
    last_ip    character varying(54) COLLATE pg_catalog."default"  DEFAULT 'unknown':: character varying,
    last_agent character varying(324) COLLATE pg_catalog."default" DEFAULT 'unknown':: character varying,
    auth_ip    character varying(54) COLLATE pg_catalog."default"  DEFAULT 'unknown':: character varying,
    auth_agent character varying(324) COLLATE pg_catalog."default" DEFAULT 'unknown':: character varying,
