<script lang="ts">
	...
	import Overlay from '$lib/components/elven/overlay.svelte';
	import Popup from '$lib/components/elven/popup.svelte';
	import Store from '$lib/tools/store';
	import Preview from '$lib/components/elven/preview.svelte';
	import { getUploadsURL, isTouchDevice } from '$lib/tools';
	import { t } from '$lib/locale';
	import NetworkFile from '$lib/network/file';
