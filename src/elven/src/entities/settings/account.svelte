<script lang="ts">
    import UserAdapter from "@/entities/user/adapter";
    import Overlay from "@/ui/overlay.svelte";
    import type { User, UserChange } from "@/entities/user/types";
    import { usernameValidate, passwordValidate } from "@/entities/user/types";
