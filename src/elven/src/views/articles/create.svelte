<script lang="ts">
  ...
  import TextareaResizer from "@/tools/textarea_resizer";
  // ui
  import Toolbar from "@/components/toolbar.svelte";
  // article
  import type { Article } from "@/types/articles";
  import NetworkArticle from "@/network/network_article";
  import ValidatorArticle from "@/validators/validator_article";
  import CategoriesSelector from "@/components/categories_selector.svelte";
  import type { Category } from "@/types/articles/categories";
  import ArticleCover from "@/components/article_cover.svelte";
  // file
  import FilesPortable from "@/components/files_portable.svelte";
  import type { File } from "@/types/files";
  import { generateFileTypeSelector } from "@/tools/extension";
  ...
  async function getArticle(id: string) {
    try {
      const result = await NetworkArticle.get(id);
      article = result;
    } catch (err) {
  ...
  async function updateArticle() {
    ...
    return await NetworkArticle.update(article);
  }
